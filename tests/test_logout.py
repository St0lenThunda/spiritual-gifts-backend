...
def test_logout_clears_cookie(client):
    """Test that /auth/logout clears the access_token cookie."""
    # 1. Login to get the cookie
    login_response = client.post("/auth/dev-login", json={"email": "logout-test@example.com"})
    ...
    me_again_response = client.get("/auth/me")
